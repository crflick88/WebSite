package io.crf.website.repository;

import io.crf.website.WebsiteApp;
import io.crf.website.config.Constants;
import io.crf.website.config.TestSecurityConfiguration;
import io.crf.website.config.audit.AuditEventConverter;
import io.crf.website.domain.PersistentAuditEvent;
...
import static io.crf.website.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
